module cnb.cool/znb/cdn-refresh

go 1.24.2

require (
	github.com/alibabacloud-go/cdn-20180510/v8 v8.0.1
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/teo v1.0.1211
