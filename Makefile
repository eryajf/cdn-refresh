...
define LDFLAGS
"-X 'github.com/eryajf/doge-cdn-refresh/cmd.Version=${VERSION}' \
 -X 'github.com/eryajf/doge-cdn-refresh/cmd.GitCommit=${GIT_COMMIT}' \
 -X 'github.com/eryajf/doge-cdn-refresh/cmd.BuildTime=${BUILD_TIME}'"
endef
